...
from models.vqgan.discriminator import PatchDiscriminator
...
# ---------------- Training engine ----------------
from vqgan_engine import train_one_epoch, evaluate_one_epoch
...
def parse_args():
    ...
    # Model
    parser.add_argument('--model', type=str, default='vqgan', choices=['vqgan'],
                        help='model name')
...
def main():
    ...
    # ------------------------- Build LPIPS -------------------------
    print(' ============= LPIPS Info. ============= ')
    lpips = LPIPS(feat_extractor="vgg").eval()
    ...
    lr_scheduler_G = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer_G, T_max=args.max_epoch - 1, eta_min=0.0)
    ...
    print_rank_0("=============== Step-1: Train Model  ===============", local_rank)
